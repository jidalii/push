...
contract PlonkVerifier {
    ...
    uint16 constant n =   4096;
    uint16 constant nPublic =  5;
    uint16 constant nLagrange = 5;
    
    uint256 constant Qmx = 11671955552571067598026036015175721117175241093826714533880354417684516874202;
    uint256 constant Qmy = 16669318740915685097627530235392214858450463270716304169898986701441630697971;
    uint256 constant Qlx = 10642624831300571253746318947445032930598573137999972175054002553171280120185;
    uint256 constant Qly = 20963717375445460857758806595389821461229802274880796488324694745069743001347;
    uint256 constant Qrx = 3701095063052975599048201442164850765791467263894868748374787876572369483765;
    uint256 constant Qry = 14455164728514851293970338473165838784554551615394536846217398468651439828763;
    uint256 constant Qox = 8503526283613024017288011766876006647899006268065903795068144065793836973419;
    uint256 constant Qoy = 14423591521276915899689224986242001356943026416392938634180023931436494723661;
    uint256 constant Qcx = 20928535162455839859954758545209470833719196898175703088600907138535564628109;
    uint256 constant Qcy = 9914544572454605792371183950835050850949010007086543181210972839012638528926;
    uint256 constant S1x = 14757629355905623907592546340986644148109654920550197534199151367828475743120;
    uint256 constant S1y = 10349995891818874070588316871022547376836520384295059023748397623851204820655;
    uint256 constant S2x = 20606390541075612337709568540500755783395999465622603139265399836522286480928;
    uint256 constant S2y = 2445510692796223865769146242865715892466636683702445536713605716283665677261;
    uint256 constant S3x = 9484690996422416284345071876085953505377618606231581204970918053892073932322;
    uint256 constant S3y = 18959078033568519848656986684758184653419213646286585717923922563137945092854;
