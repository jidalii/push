...
contract PlonkVerifier {
    ...
    uint16 constant n =   2048;
    uint16 constant nPublic =  4;
    uint16 constant nLagrange = 4;
    
    uint256 constant Qmx = 5267598886600412389645100390729320162293188761430916945271946507963626450877;
    uint256 constant Qmy = 1154695231602348783502670524588821934721043766535566290302544320413227268810;
    uint256 constant Qlx = 15304886206190357875358134191801782747357256721352515659760477875898000723856;
    uint256 constant Qly = 4641319221752811030253485177820600299273006963714588967866811394385625610138;
    uint256 constant Qrx = 14428880872220774750372533320123122762494977355436188461854080432197185384618;
    uint256 constant Qry = 482785642855948101897362107698605621984050673262114394056880524534867596984;
    uint256 constant Qox = 1316379525573615350970832921884866275930918631298000102024236542484983934054;
    uint256 constant Qoy = 7389179535264989513636821232149743272317503055588266747583398780943991236391;
    uint256 constant Qcx = 16306431942097464503656554335191723629287012583812857080391811082642751308498;
    uint256 constant Qcy = 17083440864059936414112509613835808089165772326238220213921046983036416872253;
    uint256 constant S1x = 6799693729382711079289378069926437232525756918854490139339067515213010775199;
    uint256 constant S1y = 16543236257826562836093819111343242850644107108245776270791879772322194981649;
    uint256 constant S2x = 2546383463465719733690880334172959200825768717799654945117594367008784595769;
    uint256 constant S2y = 790979196505153556188359091955295120862295970857642559335933013979663696349;
    uint256 constant S3x = 21255470774670036377688624254254524487085711260360252257183454336623587323706;
    uint256 constant S3y = 12509350404494501330875343614067681158860714799767576283461436455291247023439;
